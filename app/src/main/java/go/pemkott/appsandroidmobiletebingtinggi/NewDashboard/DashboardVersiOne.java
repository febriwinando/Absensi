...
//                koordintaEmployee();
    ...
    public void dataValidasi(String verifikator, String idE){
        if (verifikator.equals("verifikator1") || verifikator.equals("verifikator2")){
            Call<List<ValidasiData>> callKegiatan = httpService.getUrlListValidasi("https://absensi.kotakecil.gov/api/newVeriFragment?verifikator="+verifikator+"&id="+idE);
...
//    }
    ...
    public void viewJadwalKerja(){
        ...
        btnSingkronJadwalKerja.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Call<List<TimeTebleSetting>> callKegiatan = holderAPI.getUrlTimeTableSetting("https://absensi.kotakecil.gov/api/timetable?employee_id="+sEmployee_id, "Bearer "+sToken);
    ...
    public void koordinatOPD(){
        ...
        Call<List<Koordinat>> calllokasi = holderAPI.getUrlKoordinat("https://absensi.kotakecil.gov/api/koordinat?opdid="+sOPD);
    ...
    public void koordintaEmployee(){
        ...
        Call<List<Koordinat>> callKegiatan = holderAPI.getUrlKoordinat("https://absensi.kotakecil.gov/api/koordinatemployee?id="+sEmployee_id);
    ...
    public void singkronKegiatan(){
        ...
        Call<List<KegiatanIzin>> callKegiatan = holderAPI.getUrlKegiatanNew("https://absensi.kotakecil.gov/api/kegiatannew?opd="+sOPD);
